# [Django & Chart.JS](https://appseed.us/product/material-dashboard/django/) via `API`
...
---
[Django & Chart.JS](https://appseed.us/product/material-dashboard/django/) via `API` - Minimal **Django** core provided by **[AppSeed](https://appseed.us/)**
